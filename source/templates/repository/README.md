...
<table>
  ...
  <tr>
    <td colspan="2" align="center">
      <img src="https://github.com/jparruda/metrics/blob/examples/metrics.repository.svg" alt=""></img>
...
*Example: render `jparruda/metrics` repository*
```yml
...
with:
  ...
  plugin_followup: yes
  plugin_projects: yes
  plugin_projects_repositories: jparruda/metrics/projects/1
